...
- **`.github/workflows/poll-ter-rt.yml`** lance ce poll toutes les 5 min sur les fenêtres de
  pointe (04–08 h et 14–18 h UTC = 06–10 h et 16–20 h Paris, en septembre), du lundi au vendredi,
  et commit `data/rt/updates/`.
